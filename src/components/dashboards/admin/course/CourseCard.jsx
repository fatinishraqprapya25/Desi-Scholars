...
const CourseCard = ({ course, onEditCourse }) => (
    <motion.div
        key={course.id}
    ...
    >
        ...
        <div className="flex justify-end pt-2">
            <Link to={`/admin/courses/edit/${course.id}`}> {/* Dynamic link */}
                <button
                    ...
                    onClick={(e) => { e.stopPropagation(); onEditCourse(course.id); }} // Prevent Link navigation if onClick is also used
                    title="Edit Course"
                >
