            ...
            {hasStudents ? (
                <table className="min-w-full divide-y divide-gray-200 table-auto">
                    <thead className="bg-gray-50">
                        <tr>
                            {[{ key: 'id', label: 'ID' }, { key: 'name', label: 'Name' }, { key: 'email', label: 'Email', className: 'hidden sm:table-cell' }, { key: 'enrolledCourses', label: 'Courses', className: 'hidden md:table-cell text-center' }, { key: 'status', label: 'Status' }, { key: 'lastLogin', label: 'Last Login', className: 'hidden lg:table-cell' }, { noSort: true, classNameHeader: 'text-center' }].map(header => (
                                <th
                                    key={header.key}
                                    scope="col"
