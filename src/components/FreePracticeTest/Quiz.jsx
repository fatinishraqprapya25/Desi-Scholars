...
// Re-export examsData from FreeTestPage or create a separate data file
// For simplicity, we'll re-define it here, but ideally, it would be imported from a central location.
const examsData = [
    {
        id: 1,
