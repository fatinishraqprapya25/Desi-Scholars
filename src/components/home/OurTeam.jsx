            ...
            <Container>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    {teamMembers.map(({ name, position, bio, photo, socials }, index) => (
                        <motion.div
                            key={name}
                            className="relative bg-gray-50 rounded-lg p-6 shadow-lg flex flex-col items-center text-center group"
                            custom={index}
                            initial="hidden"
                            whileInView="visible"
                            whileHover="hover"
                        ...
                        >
                            ...
                            {/* Social links */}
                            <div className="absolute inset-0 bg-indigo-600 bg-opacity-90 rounded-lg flex items-center justify-center space-x-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <a
