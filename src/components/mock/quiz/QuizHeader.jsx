...
export default function QuizHeader({ moduleName, initialMinutes, initialSeconds }) {
    ...
    return (
        <>
            <header className="w-full bg-purple-100 p-2 sm:p-3 rounded-lg shadow-md grid grid-cols-3 sm:flex-row items-center sm:items-center justify-between border-b border-gray-300 custom-dashed-border">
            ...
            <div className="max-w-6xl mx-auto bg-purple-500 text-white text-lg font-bold text-center py-1 rounded-b-xl">
                This is Mock Test
            </div>
        </>
    );
